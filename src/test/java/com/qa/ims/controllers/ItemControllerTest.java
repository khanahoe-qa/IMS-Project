...
public class ItemControllerTest {
	...
	public void testCreate() {
		...
		final Integer STOCK_LEVEL = 99;
		final Float PRICE = 3.50f;
		final Item created = new Item(NAME, STOCK_LEVEL, PRICE);

		Mockito.when(utils.getString()).thenReturn(NAME);
		Mockito.when(utils.getInt()).thenReturn(STOCK_LEVEL);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, "Girder", 13, 199.99f));
	...
	public void testUpdate() {
		Item updated = new Item(1L, "Gizmo", 76, 5.50f);
